...
function placeXOrO(squareNumber) {
    // This condition ensures a squaare hasn't been selected already.
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        // Active player may only be 'X' of 'O' so, if not 'X' it must be 'O'
        } else {
    ...
    function computersTurn() {
        ...
        let pickASquare;
        // This condition allows our while loop to keep trying if a suqare is selected already.
        while(!success) {
...
function audio(audioURL) {
    // We create a new audio object and we passs the path as a parameter.
